...
public class RegisterJFrame extends JFrame implements MouseListener, KeyListener {
    ...
    private void initImage() {
        ...
        //添加注册用户名
        ImageIcon userImage = new ImageIcon("puzzlegame\\image\\register\\注册用户名.png");
        ...
        //添加密码图片
        ImageIcon passwordImage=new ImageIcon("D:\\java\\IdeaProjects\\puzzlegame\\image\\register\\注册密码.png");
        ...
        //添加确定密码图片
        ImageIcon secondPasswordImage=new ImageIcon("puzzlegame\\image\\register\\再次输入密码.png");
        ...
        //添加注册按钮
        ImageIcon registerImage=new ImageIcon("puzzlegame\\image\\login\\注册按钮.png");
        ...
        //添加重置按钮
        ImageIcon restartImage=new ImageIcon("puzzlegame\\image\\register\\重置按钮.png");
