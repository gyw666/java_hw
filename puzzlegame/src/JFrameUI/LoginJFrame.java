...
public class LoginJFrame extends JFrame implements ActionListener, KeyListener, MouseListener {
    ImageIcon pswImage=new ImageIcon("puzzlegame\\image\\login\\密码.png");
    JLabel ps=new JLabel();

    ImageIcon userImage=new ImageIcon("puzzlegame\\image\\login\\用户名.png");
    ...
    private void initImage(){
        ...
        //添加背景图片
        ImageIcon bg=new ImageIcon("puzzlegame\\image\\login\\background.png");
    ...
    public void mousePressed(MouseEvent e) {
        if(e.getSource()==loginButton){
            loginImage=new ImageIcon("puzzlegame\\image\\login\\登录按下.png");
